# Generated by Powerlevel10k configuration wizard on 2022-02-17 at 10:38 JST.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local conflicted='%202F'  # red foreground
    else
    ...
    (( VCS_STATUS_NUM_UNSTAGED   )) && res+=" ${untracked}!${VCS_STATUS_NUM_UNSTAGED}"
  ...
  # Custom prefix.
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_PREFIX='祥'
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_FOREGROUND=26
  ...
  ################[ pyenv: python environment (https://github.com/pyenv/pyenv) ]################
  # Pyenv color.
  typeset -g POWERLEVEL9K_PYENV_FOREGROUND=26
  ...
  ##############################[ node_version: node.js version ]###############################
  # Node version color.
  typeset -g POWERLEVEL9K_NODE_VERSION_FOREGROUND=29
  ...
  ###[ package: name@version from package.json (https://docs.npmjs.com/files/package.json) ]####
  # Package color.
  typeset -g POWERLEVEL9K_PACKAGE_FOREGROUND=29
